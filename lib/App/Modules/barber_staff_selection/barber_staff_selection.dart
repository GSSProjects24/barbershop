...
// Shimmer loading effect for categories
  ...
  // Cart Section
  Widget _buildCartSection(CartController controller) {
    return Column(
      children: [
        _buildBarberSelection(controller),
        const SizedBox(height: 16),

        // ✅ MAIN CHANGE: Wrap in Expanded with SingleChildScrollView
        Expanded(
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                // ✅ ADD POINTS REDEMPTION WIDGET HERE
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search by phone number (e.g., 012, 015)...',
                              ...
                              Expanded(
                                child: ElevatedButton(
                                  onPressed: () async {
                                    ...
                                    // Store phone number for search later
                                    final phoneToSearch = dialogPhoneController.text;

                                    // Set the values to the controller's text fields
                                    ...
                                    // Wait a moment for the customer list to refresh
                                    await Future.delayed(const Duration(milliseconds: 500));

                                    // Search for the newly created customer
                                    searchController.text = phoneToSearch;
                                    filteredCustomers.value = controller.customers
                                        .where((customer) =>
                                        customer.phone.toLowerCase().contains(phoneToSearch.toLowerCase()))
                                        .toList();

                                    // Auto-select if found
                                    if (filteredCustomers.isNotEmpty) {
                                      final newCustomer = filteredCustomers.firstWhere(
                                            (customer) => customer.phone == phoneToSearch,
                                        orElse: () => filteredCustomers.first,
                                      );
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          ElevatedButton.icon(
                            onPressed: () {
                              // Pre-fill phone number if user was searching
                      ...
                      return ListTile(
                        ...
                        trailing: isSelected
                          ...
                          size: 24,
                            ...
                            : null,
                        selected: isSelected,
                        selectedTileColor: const Color(0xFF667EEA).withOpacity(0.05),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(8),
                        ),
                        onTap: () {
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            // ✅ FIXED: Show total points (pointsEarned × quantity)
                            Row(
                              children: [
                                Icon(Icons.star,
